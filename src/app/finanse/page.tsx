...
export const metadata = {
  ...
  description:
    "Darmowe kalkulatory finansowe. Oblicz VAT, leasing, wynagrodzenie brutto i netto oraz inne wartości.",
};
        ...
        <div className="mx-auto max-w-7xl px-5 pb-16 pt-14 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">
              Szybko przeliczaj VAT, wynagrodzenia, leasing
              i inne wartości finansowe.
            </p>
      ...
      <section className="bg-white py-16">
        ...
        <div className="mx-auto max-w-4xl px-5 sm:px-6">
          ...
          <h2 className="text-3xl font-black">
            Proste kalkulatory finansowe
          </h2>

          <p className="mt-5 leading-8 text-slate-600">
            Narzędzia finansowe na PoliczDobrze pomagają
            szybko wykonywać codzienne obliczenia bez konieczności
            ręcznego przeliczania wartości.
          </p>
