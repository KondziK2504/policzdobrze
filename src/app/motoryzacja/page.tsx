...
export const metadata = {
  ...
  description:
    "Darmowe kalkulatory motoryzacyjne. Oblicz spalanie samochodu, koszt paliwa, koszt przejazdu oraz koszt sprowadzenia auta.",
};
        ...
        <div className="mx-auto max-w-7xl px-5 pb-16 pt-14 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">
              Sprawdź spalanie, koszt paliwa, koszt przejazdu
              oraz orientacyjny koszt sprowadzenia samochodu.
            </p>
      ...
      <section className="bg-white py-16">
        ...
        <div className="mx-auto max-w-4xl px-5 sm:px-6">
          ...
          <p className="mt-5 leading-8 text-slate-600">
            Koszty samochodu można łatwo policzyć, jeśli znamy
            podstawowe dane dotyczące spalania, dystansu i ceny paliwa.
          </p>

          <p className="mt-5 leading-8 text-slate-600">
            PoliczDobrze pozwala szybko obliczyć spalanie,
            koszt przejazdu i koszt paliwa, a w przyszłości
            także inne wydatki związane z samochodem.
          </p>
